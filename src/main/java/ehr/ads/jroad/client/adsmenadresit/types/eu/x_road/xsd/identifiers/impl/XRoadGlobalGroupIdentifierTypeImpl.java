 ...
 */
public class XRoadGlobalGroupIdentifierTypeImpl extends ehr.ads.jroad.client.adsmenadresit.types.eu.x_road.xsd.identifiers.impl.XRoadIdentifierTypeImpl implements ehr.ads.jroad.client.adsmenadresit.types.eu.x_road.xsd.identifiers.XRoadGlobalGroupIdentifierType
{
    private static final long serialVersionUID = 1L;
    
    public XRoadGlobalGroupIdentifierTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName GROUPCODE$2 = 
    ...
    public java.lang.String getGroupCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(GROUPCODE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetGroupCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(GROUPCODE$2, 0);
            return target;
        }
    }
    ...
    public boolean isSetGroupCode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GROUPCODE$2) != 0;
        }
    }
    ...
    public void setGroupCode(java.lang.String groupCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(GROUPCODE$2);
            }
    ...
    public void xsetGroupCode(org.apache.xmlbeans.XmlString groupCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(GROUPCODE$2);
            }
    ...
    public void unsetGroupCode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GROUPCODE$2, 0);
        }
    }
